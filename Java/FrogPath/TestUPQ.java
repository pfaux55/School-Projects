...
public class TestUPQ {
	...
	private static boolean test08 () {
		...
		return b1 && s.equals("yellow [2.0], black [2.0], blue [3.0], pink [3.0], cyan [5.0], "
				+ "white [5.0], red [7.0], green [8.0], orange [8.0], purple [9.0]");
	}
	...
	public static void main(String[] args) {
		...
		} catch (Exception e) { System.out.println("TestUPQ - Test 2 Failed (exception)"+e); }
		...
		} catch (Exception e) { System.out.println("TestUPQ - Test 8 Failed (exception)" + e); }
